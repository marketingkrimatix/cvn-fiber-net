...
export default function RootLayout({ children }: LayoutProps<"/">) {
  ...
  return <html lang="en" data-theme="dark" suppressHydrationWarning><head><script dangerouslySetInnerHTML={{__html:`try{document.documentElement.dataset.theme=localStorage.getItem('cvn-theme')||'dark'}catch(e){document.documentElement.dataset.theme='dark'}`}} /><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(business)}} /></head><body>{children}</body></html>;
}
